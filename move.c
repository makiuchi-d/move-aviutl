...
// チップテキスト
#define TSTR_NKEY "次のキーフレームに移動"
#define TSTR_LKEY "前のキーフレームに移動"
#define TSTR_NMRK "次のマークフレームに移動"
#define TSTR_LMRK "前のマークフレームに移動"
#define TSTR_NDEL "次の優先間引きフレームに移動"
#define TSTR_LDEL "前の優先間引きフレームに移動"
#define TSTR_NCPY "次のコピーフレームに移動"
#define TSTR_LCPY "前のコピーフレームに移動"
...
char filter_info[] = "移動ツール ver0.01 by MakKi";
#define track_N 0
#if track_N
